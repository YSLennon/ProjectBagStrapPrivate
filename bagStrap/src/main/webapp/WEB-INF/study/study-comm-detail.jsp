    ...
    const app = Vue.createApp({
        ...
        methods: {
			fnupdateCommentReResult(commentId,comcontents,boardId){
              ...
              $.ajax({
                  url:"/bagStrap/updateCommentReResult.dox",
                  dataType:"json",    
                  type : "POST", 
                  data : nparmap,
			...
			fnReCommChat(commentId){
	              ...
	              $.ajax({
	                  url:"/bagStrap/updateCommentREY.dox",
	                  dataType:"json",    
	                  type : "POST", 
	                  data : nparmap,
	                  success : function(data) { 
            ...
            fnReChat(commentId){
               ...
               $.ajax({
                   url:"/bagStrap/updateCommentRENO.dox",
                   dataType:"json",    
                   type : "POST", 
                   data : nparmap,
                   success : function(data) { 
            ...
            fnCommUpdateNo(boardId){
                ...
                var nparmap = {boardId : boardId};
                $.ajax({
                    url:"/bagStrap/updateCommentNO.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fnupdateCommentResult(commentId,comcontents){
                ...
                $.ajax({
                    url:"/bagStrap/updateCommentResult.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fnCommUpdate(commentId){
                ...
                var nparmap = {commentId : commentId};
                $.ajax({
                    url:"/bagStrap/updateComment.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fnCommhide(commentId,commentstatus){
                ...
                $.ajax({
                    url:"/bagStrap/updateStatusBoardComment.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fnCommDelete(commentId){
                ...
                var nparmap = {commentId : commentId};
                $.ajax({
                    url:"/bagStrap/deleteBoardComment.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fnUpdate(boardId){
                $.pageChange("/bagStrap/study-comm-Update",{boardId : boardId});
            },
            fnhide(boardstatus){
                var self = this;
                var nparmap = {boardId : self.boardId, boardstatus : boardstatus };
                $.ajax({
                    url:"/bagStrap/updateStatusBoard.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fnBoardTypeList(boardTypeId,name){
                $.pageChange("/bagStrap/study-comm",{boardTypeId2 : boardTypeId, name : name});
            },        
            fnView(){
                var self = this;
                var nparmap = {boardId : self.boardId};
            ...
            fnSave(){
                ...
                $.ajax({
                    url:"/bagStrap/insertViewComment.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fnCommLike(boardId){
                ...
                var nparmap = {boardId : boardId,
                               userId : self.sessionUserId};
                $.ajax({
                    url:"/bagStrap/insertCommLike.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fnCommentLike(boardId){
                ...
                var nparmap = {boardId : boardId,
                               userId : self.sessionUserId};
                $.ajax({
                    url:"/bagStrap/insertCommentLike.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fndeleteCommLike(boardId){
                ...
                var nparmap = {boardId : boardId,
                               userId : self.sessionUserId};
                $.ajax({
                    url:"/bagStrap/deleteCommentLike.dox",
                    dataType:"json",    
                    type : "POST", 
                    data : nparmap,
                    success : function(data) { 
            ...
            fnLikeCheck(boardId,type) {
                ...
                $.ajax({
                    url: "/bagStrap/selectLikeCheck.dox",
                    dataType: "json",
                    type: "POST",
                    data: nparmap,
                    success: function(data) {
