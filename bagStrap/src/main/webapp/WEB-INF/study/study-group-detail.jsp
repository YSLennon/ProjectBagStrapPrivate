	...
	<main class="main-container">
		...
		<div id="app" class="content">
            <div class="stu-group-detail">              
                <img src="${uploadUrlPath}스터디디테일.png" alt="책 표지" style="width: 100%; max-width: 400px; display: block; margin: 0 auto 20px auto;">
            ...
            methods: {
				fncancle(){
			     ...
			     fnJoinSubscription(studyGroupId,selfIntro,studyGoal,additionalQuestions){
		              ...
		              $.ajax({
		                  url:"${pageContext.request.contextPath}/selectStuGroupSubscription.dox",
		                  dataType:"json",    
		                  type : "POST", 
		                  data : nparmap,
				...
				fnJoin(studyGroupId,selfIntro,studyGoal,additionalQuestions){
					var self = this;
		              ...
		              $.ajax({
		                  url:"${pageContext.request.contextPath}/insertStuGroupApply.dox",
		                  dataType:"json",    
		                  type : "POST", 
		                  data : nparmap,
		                  success : function(data) { 
